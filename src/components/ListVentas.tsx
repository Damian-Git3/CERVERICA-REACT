    ...
    <div className="p-4">
      <Card title="Lista de Ventas" className="p-shadow-2 p-p-4">
        ...
        <DataTable
          ...
          onRowClick={(e) => handlePressVenta(e.data.id)}
        >
          ...
          <Column
            ...
            header="Fecha"
            body={(data) =>
              new Date(data.fechaVenta).toLocaleString("es-ES", {
                day: "2-digit",
                month: "2-digit",
                year: "numeric",
                hour: "2-digit",
          ...
          <Column
            ...
            body={(data) => obtenerMetodoEnvio(data.metodoEnvio)}
          />
          <Column
            field="metodoPago"
            header="Método de Pago"
            body={(data) => obtenerMetodoPago(data.metodoPago)}
          />
          <Column
            field="estatusVenta"
            header="Estatus"
            body={(data) => (
              <span
                className={`badge bg-${
                  severityColors[obtenerSeverityEstatusVenta(data.estatusVenta)]
                }`}
              >
